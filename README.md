...
mkdir -p ~/workspace
cd ~/workspace
git clone https://github.com/Aramark/workstation-setup.git
...
The list of Engineering applications is found in: [applications-common.sh] (https://github.com/Aramark/workstation-setup/blob/master/scripts/applications-common.sh)
...
In addition to the Engineering applications, this script also installs the list of Design applications found in: [applications-designer.sh]  (https://github.com/Aramark/workstation-setup/blob/master/scripts/applications-designer.sh)
